...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    catch (err) { setError(err.response?.data?.message || 'Unable to log in. Please try again.'); }
    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-surface-50 via-white to-brand-50">
      <div className="w-full max-w-sm animate-slide-up">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-surface-500 mt-1">Log in to your TaskFlow workspace</p>
        </div>
